...
#####################################################################
# © Code Project Discussion Board                                   #
# Created by Hassan on Aug., 30, 2001                               #
# This can be modifyied and re-distrubted. All changes should be    #
# reported to me. Check for newer versions. You can change it the   #
# way you like and add features. Please let me know of all the new  #
# features you add. Then i can update it !                          #
#####################################################################
# BETA 1. Written with Perl 5.                                      #
# Tested under Apache for Win32.                                    #
# Uses text database and newer releases will use mySQL database.    #
# Newer version will also include a admin section.                  #
